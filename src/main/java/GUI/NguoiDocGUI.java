...
public class NguoiDocGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTableNguoiDoc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ Tên", "SDT", "Ngày sinh", "Địa chỉ", "CMND", "Hạn sử dụng", "Số lượng mượn cho phép", "Trạng thái vi phạm"
            }
        ) {
        ...
        jLabel2.setText("Danh sách người đọc");
        jPanel1.add(jLabel2);
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        ...
        jFileChooserImport.addChoosableFileFilter(filter);
        jFileChooserImport.setFileFilter(filter);

        int returnValue = jFileChooserImport.showOpenDialog(null);
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            File selectedFile = jFileChooserImport.getSelectedFile();
            String excelFilePath = selectedFile.toString();
            try {
                ArrayList<NguoiDocDTO> listNguoiDoc = ImportExcel.readExcel(excelFilePath);
                NguoiDocBUS nguoiDocBUS = new NguoiDocBUS();
                int count = nguoiDocBUS.insertMany(listNguoiDoc);
                setTableItemList();
                JOptionPane.showMessageDialog(this, String.format("Done insert %d rows", count));
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        // Excel files filter
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Excel files", "xlsx", "xls");
        jFileChooserExport.addChoosableFileFilter(filter);
        jFileChooserExport.setFileFilter(filter);

        int returnValue = jFileChooserExport.showSaveDialog(null);
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            File selectedFile = jFileChooserExport.getSelectedFile();
            String excelFilePath = selectedFile.toString();
            // If not end with .xlsx
            ...
            try {
                ExportExcel.writeExcel(nguoiDocBUS.getListNguoiDoc(), excelFilePath,
                        "Người đọc", columnsHeader);
    ...
    private void btnReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportActionPerformed
        ...
        try {
            ...
            String reportPath = currentDirFile + "\\src\\main\\report\\NguoiDoc.jrxml";
