...
public class TacGiaGUI extends javax.swing.JPanel {
    ...
    public void setTableItemList(TacGiaBUS tacGiaBUS) {
        ...
        for (TacGiaDTO tacGia : listTacGia) {
            tacGiaTableModel.addRow(new Object[]{tacGia.getIdTacGia(), tacGia.getHoTen(), tacGia.getDiaChi()});
        }
    }
...
//            Object obj = jtableTacGia.getValueAt(selectedRow, col);
//            if (col == 3) {
//                try {
//                    //NgaySinh
...
//                    Logger.getLogger(TacGiaGUI.class.getName()).log(Level.SEVERE, null, ex);
//                }
//            } else {
...
//        jDialogTimKiem.setVisible(false);
    ...
    private void btnXacNhanThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanThemActionPerformed
        ...
        TacGiaDTO tacGiaDTO = new TacGiaDTO(id, ten, diaChi);
        TacGiaBUS tacGiaBUS = new TacGiaBUS();
